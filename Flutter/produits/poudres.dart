...
class Poudres extends StatefulWidget{
  @override
  _PoudresState createState() => _PoudresState();
}

class _PoudresState extends State<Poudres> {

  List list = [];

  Future ReadData() async{

    var url = "http://192.168.1.100/essentioil/poudres.php";
