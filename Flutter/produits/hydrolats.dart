...
class Hydrolats extends StatefulWidget{
  @override
  _HydrolatsState createState() => _HydrolatsState();
}

class _HydrolatsState extends State<Hydrolats> {

  List list = [];

  Future ReadData() async{

    var url = "http://192.168.1.100/essentioil/hydrolats.php";
