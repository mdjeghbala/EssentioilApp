...
class VosCheveux extends StatefulWidget{
  @override
  _VosCheveuxState createState() => _VosCheveuxState();
}

class _VosCheveuxState extends State<VosCheveux> {

  List list = [];

  Future ReadData() async {
    var url = "http://192.168.1.100/essentioil/voscheveux.php";
